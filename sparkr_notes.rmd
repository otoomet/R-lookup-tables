...
Syntax: `regexp_replace(column, pattern, replacement)`.  Pattern is a
regexp. 

Note: regexp is in
[_java regexp syntax_](https://docs.oracle.com/javase/7/docs/api/java/util/regex/Pattern.html). 
...
In particular, java denotes replacement groups by $1, $2 and so on:
