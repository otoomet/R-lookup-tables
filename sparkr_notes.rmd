...
specific point of time, say a phone call.  Both dates and timestamps
can be converted to each other.  

Comparing a date and a timestamp assumes the date is a timestamp that
occurs 00:00:00 am at that date.


## Converting character representation into timestamps
