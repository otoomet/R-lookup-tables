...
created.  There are also other PTS options you can use for analysis
here, e.g. _executive-summary_ or _result-file-stats_.


## How to create a personal phoronix test suite

There are several reasons to create a new customized test suite.  In
particular, you want to run a few tests you are interested on systems
you care about.  The existing test suites tend to be focused on a
